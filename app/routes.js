...
// normal routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        db.collection('runTrack').find().toArray((err, result) => {
...
// message board routes ===============================================================
    ...
    app.post('/personal', (req, res) => {
      ...
      db.collection('runTrack').save({ msg: parseInt(req.body.msg), pageNum:parseInt( req.body.pageNum )}, (err, result) => {
        if (err) return console.log(err)
...
//
    ...
    app.delete('/delete', (req, res) => {
      ...
      db.collection('runTrack').findOneAndDelete({msg: parseInt(req.body.name), pageNum: parseInt(req.body.msg)}, (err, result) => {
